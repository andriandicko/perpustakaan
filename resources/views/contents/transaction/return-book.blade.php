...
@section('content')
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <div>
            <h1 class="h3 mb-3 text-gray-800 d-flex justify-content-between ">Books Return</h1>
        </div>
        ...
        <div class="card shadow mb-4">
            <div class="card-body" style="height: 450px;">
                <div class="col-12 col-md-8 offset-md-2 col-lg-6 offset-md-3 mt-5">
                    <h3 class="mb-3 text-center font-weight-bold ">Book Return</h3>

                    {{-- Alert // diambil dari Controller saveReturnBook --}}
                    @if (session('message'))
